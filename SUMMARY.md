...
* [Language Spec](language-spec/README.md)
  * [Foundation](language-spec/basics/README.md)
  ...
  * [Functions of simple types](language-spec/functions-of-simple-types/README.md)
    * [int](language-spec/functions-of-simple-types/int.md)
    * [string](language-spec/functions-of-simple-types/string.md)
    * [float](language-spec/functions-of-simple-types/dec.md)
